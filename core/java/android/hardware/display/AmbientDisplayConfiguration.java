...
public class AmbientDisplayConfiguration {
    ...
    public boolean alwaysOnChargingEnabled(int user) {
        final boolean dozeOnChargeEnabled = boolSetting(Settings.Secure.OMNI_DOZE_ON_CHARGE, user, 0);
        if (dozeOnChargeEnabled) {
            final boolean dozeOnChargeEnabledNow = boolSetting(Settings.Secure.OMNI_DOZE_ON_CHARGE_NOW, user, 0);
