...
public class WeatherClient {
    ...
    public static final String SERVICE_PACKAGE = "co.potatoproject.weather.client";
    private static final String SERVICE_PACKAGE_PERMISSION = SERVICE_PACKAGE + ".READ_WEATHER";
    public static final Uri WEATHER_URI = Uri.parse("content://co.potatoproject.weather.client.provider/weather");
