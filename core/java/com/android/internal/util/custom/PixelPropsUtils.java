...
public class PixelPropsUtils {
    ...
    private static final String DEVICE = "ro.potato.device";
    ...
    public static void setProps(String packageName) {
        ...
        if ((packageName.startsWith("com.google.") && !Arrays.asList(packagesToKeep).contains(packageName)) || Arrays.asList(extraPackagesToChange).contains(packageName)){
