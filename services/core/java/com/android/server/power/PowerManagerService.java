...
public final class PowerManagerService extends SystemService
    ...
    public void systemReady(IAppOpsService appOps) {
        ...
        Settings.Secure.putIntForUser(mContext.getContentResolver(),
                Settings.Secure.OMNI_DOZE_ON_CHARGE_NOW, 0, UserHandle.USER_CURRENT);
        ...
        resolver.registerContentObserver(Settings.System.getUriFor(
                ...
                false, mSettingsObserver, UserHandle.USER_ALL);
        resolver.registerContentObserver(Settings.Secure.getUriFor(
                Settings.Secure.OMNI_DOZE_ON_CHARGE_NOW),
                false, mSettingsObserver, UserHandle.USER_ALL);
        resolver.registerContentObserver(Settings.Secure.getUriFor(
                Settings.Secure.OMNI_DOZE_ON_CHARGE),
                false, mSettingsObserver, UserHandle.USER_ALL);
        ...
        if ((dirty & DIRTY_BATTERY_STATE) != 0) {
            ...
            if (wasPowered != mIsPowered || oldPlugType != mPlugType) {
                ...
                if (mDozeOnChargeEnabled) {
                    Settings.Secure.putIntForUser(mContext.getContentResolver(),
                            Settings.Secure.OMNI_DOZE_ON_CHARGE_NOW, mIsPowered ? 1 : 0,
                            UserHandle.USER_CURRENT);
                }
