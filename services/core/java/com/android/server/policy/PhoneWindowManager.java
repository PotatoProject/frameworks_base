        ...
        if (!mPowerKeyHandled) {
            if (interactive) {
                ...
                if ((mTorchActionMode == 2) || (mSupportLongPressPowerWhenNonInteractive
                    ...
                    if ((mTorchActionMode != 1) || (mTorchActionMode == 1 && isScreenOn() && !isDozeMode()) ||
                                (!mSoundSwitchToggle) || (mSoundSwitchToggle && isScreenOn() && !isDozeMode())) {
                        wakeUpFromPowerKey(event.getDownTime());
                    }
    ...
    private void interceptPowerKeyUp(KeyEvent event, boolean interactive, boolean canceled) {
        ...
        if (!handled) {
            ...
            if (mPowerKeyPressCounter < maxCount) {
                ...
                mHandler.sendMessageDelayed(msg, mSoundSwitchToggle
                        ? TORCH_DOUBLE_TAP_DELAY : ViewConfiguration.getMultiPressTimeout());
                return;
            }
            ...
            switch (mShortPressOnPowerBehavior) {
                ...
                case SHORT_PRESS_POWER_CLOSE_IME_OR_GO_HOME: {
                    ...
                    break;
                        ...
                        mSoundSwitchToggle && (!isScreenOn() || isDozeMode())) {
