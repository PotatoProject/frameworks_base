...
public class MiSound extends AudioEffect {
    ...
    public void setMode(int mode)
        ...
        checkStatus(setParameter(MISOUND_PARAM_MODE, mode));
    ...
    public int getMode() throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
        int[] value = new int[1];
        checkStatus(getParameter(MISOUND_PARAM_MODE, value));
    ...
    public void setMovie(int enable)
            throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
        checkStatus(setParameter(MISOUND_PARAM_MOVIE, enable));
    ...
    public int getMovie() throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
        int[] value = new int[1];
        checkStatus(getParameter(MISOUND_PARAM_MOVIE, value));
    ...
    public void setLevel(int band, float level)
            throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
        checkStatus(setParameter(new int[] { MISOUND_PARAM_EQ_LEVEL, band }, String.valueOf(level).getBytes()));
    ...
    public void setMovieMode(int mode)
            throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
        checkStatus(setParameter(MISOUND_PARAM_MOVIE_MODE, mode));
    ...
    public int getMovieMode() throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
        int[] value = new int[1];
        checkStatus(getParameter(MISOUND_PARAM_MOVIE_MODE, value));
    ...
    public void setSpeakerStereoMode(int mode)
            throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
        checkStatus(setParameter(MISOUND_PARAM_SPEAKER_STEREO_MODE, mode));
    ...
    public int getSpeakerStereoMode()
            throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
        int[] value = new int[1];
        checkStatus(getParameter(MISOUND_PARAM_SPEAKER_STEREO_MODE, value));
    ...
    public void setHifiMode(int mode)
            throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
        checkStatus(setParameter(MISOUND_PARAM_HIFI_MODE, mode));
    ...
    public int getHifiMode() throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
        int[] value = new int[1];
        checkStatus(getParameter(MISOUND_PARAM_HIFI_MODE, value));
