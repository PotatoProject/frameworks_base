...
public class KeyguardSliceProviderPosp extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        AddShadowTask(KeyguardSliceProviderPosp keyguardSliceProviderPosp, SmartSpaceCard smartSpaceCard) {
            this.mProviderReference = new WeakReference<>(keyguardSliceProviderPosp);
            this.mWeatherCard = smartSpaceCard;
            this.mBlurRadius = keyguardSliceProviderPosp.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            ...
            synchronized (this) {
                ...
                keyguardSliceProviderPosp = this.mProviderReference.get();
            }
