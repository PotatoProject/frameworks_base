package com.posp.android.systemui.keyguard;
...
public class KeyguardSliceProviderPosp extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderPosp> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderPosp keyguardSliceProviderPosp, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderPosp);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderPosp.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderPosp keyguardSliceProviderPosp;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderPosp = (KeyguardSliceProviderPosp) mProviderReference.get();
            }
            if (keyguardSliceProviderPosp != null) {
                keyguardSliceProviderPosp.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderPosp#onBindSlice");
        Slice slice;
