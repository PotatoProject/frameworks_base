package com.posp.android.systemui.smartspace
...
class KeyguardSmartspaceController @Inject constructor(
    ...
    init {
        if (!featureFlags.isSmartspaceEnabled()) {
            context.packageManager.setComponentEnabledSetting(ComponentName("com.android.systemui", "com.posp.android.systemui.keyguard.KeyguardSliceProviderPosp"), 1, 1)
        } else {
