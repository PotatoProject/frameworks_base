...
public class KeyguardStatusView extends GridLayout implements
    ...
    private void refreshTime() {
        ...
        if (mClockSelection == 0 || mWasLatestViewSmall) {
            ...
            mClockView.setFormat12Hour(Html.fromHtml("hh<br><font color=" + AccentUtils.getAccentColor(getResources().getColor(R.color.sammy_clock_accent)) + ">mm</font>"));
            mClockView.setFormat24Hour(Html.fromHtml("kk<br><font color=" + AccentUtils.getAccentColor(getResources().getColor(R.color.sammy_clock_accent)) + ">mm</font>"));
        } else if (mClockSelection == 6) {
            mClockView.setFormat12Hour(Html.fromHtml("<strong>hh</strong><br><font color=" + AccentUtils.getAccentColor(getResources().getColor(R.color.sammy_clock_accent)) + ">mm</font>"));
            mClockView.setFormat24Hour(Html.fromHtml("<strong>kk</strong><br><font color=" + AccentUtils.getAccentColor(getResources().getColor(R.color.sammy_clock_accent)) + ">mm</font>"));
        } else if (mClockSelection == 7) {
            mClockView.setFormat12Hour(Html.fromHtml("<font color='#454545'>hh</font><br><font color=" + AccentUtils.getAccentColor(getResources().getColor(R.color.sammy_clock_accent)) + ">mm</font>"));
            mClockView.setFormat24Hour(Html.fromHtml("<font color='#454545'>kk</font><br><font color=" + AccentUtils.getAccentColor(getResources().getColor(R.color.sammy_clock_accent)) + ">mm</font>"));
