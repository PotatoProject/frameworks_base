...
public class OverviewProxyService implements CallbackController<OverviewProxyListener>, Dumpable {
    ...
    private void updateEnabledState() {
        boolean isDefaultOrSysui = "com.android.systemui".equals(mRecentsComponentName.getPackageName());
        if (!isDefaultOrSysui) {
            ...
            for (ComponentName activity : activities) {
                if (activity.getPackageName().equals(mRecentsComponentName.getPackageName())) {
                    isDefaultOrSysui = true;
                }
            }
        }

        mIsEnabled = isDefaultOrSysui && mContext.getPackageManager().resolveServiceAsUser(mQuickStepIntent,
