...
public class QSTileBaseView extends com.android.systemui.plugins.qs.QSTileView {
    ...
    public QSTileBaseView(Context context, QSIconView icon, boolean collapsedView) {
        ...
        mShouldTint = Settings.System.getIntForUser(context.getContentResolver(),
                Settings.System.QS_TILES_TINT, 0, UserHandle.USER_CURRENT) == 1;
    ...
    private void setActiveColor(Context context) {
        if (mShouldDisco)
            ...
            if (mShouldTint)
                mColorActive = androidx.core.graphics.ColorUtils.setAlphaComponent(activeColor, 51 /* 20% opacity */);
            else
