...
public class QSTileBaseView extends com.android.systemui.plugins.qs.QSTileView {
    ...
    public QSTileBaseView(Context context, QSIconView icon, boolean collapsedView) {
        ...
        shouldDisco = Settings.System.getIntForUser(context.getContentResolver(),
        ...
        mColorActive = setActiveColor(context);
    ...
    private int setActiveColor(Context context) {
        if (shouldDisco && useFWbg)
