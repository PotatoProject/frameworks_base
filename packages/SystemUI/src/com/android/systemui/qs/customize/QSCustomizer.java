...
public class QSCustomizer extends LinearLayout implements OnMenuItemClickListener {
        ...
        switch (item.getItemId()) {
            case R.id.menu_item_reset:
                ...
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.CUSTOM_QS_LAYOUT_COLUMNS, 3, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_four:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.CUSTOM_QS_LAYOUT_COLUMNS, 4, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_five:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.CUSTOM_QS_LAYOUT_COLUMNS, 5, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_landscape_four:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.CUSTOM_QS_LAYOUT_COLUMNS_LANDSCAPE, 4, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_landscape_five:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.CUSTOM_QS_LAYOUT_COLUMNS_LANDSCAPE, 5, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_landscape_six:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.CUSTOM_QS_LAYOUT_COLUMNS_LANDSCAPE, 6, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_landscape_seven:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.CUSTOM_QS_LAYOUT_COLUMNS_LANDSCAPE, 7, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_landscape_eight:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.CUSTOM_QS_LAYOUT_COLUMNS_LANDSCAPE, 8, UserHandle.USER_CURRENT);
                break;
        }
        updateSettings();
        return false;
    ...
    private void reset() {
        ...
        Settings.System.putIntForUser(mContext.getContentResolver(),
                Settings.System.CUSTOM_QS_LAYOUT_COLUMNS, mDefaultColumns,
                UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(mContext.getContentResolver(),
                Settings.System.CUSTOM_QS_LAYOUT_COLUMNS_LANDSCAPE, mDefaultColumns,
                UserHandle.USER_CURRENT);
        updateSettings();
    }
    ...
    public void updateSettings() {
        ...
        int columns = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.CUSTOM_QS_LAYOUT_COLUMNS, mDefaultColumns,
                UserHandle.USER_CURRENT);
        int columnsLandscape = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.CUSTOM_QS_LAYOUT_COLUMNS_LANDSCAPE, mDefaultColumns,
                UserHandle.USER_CURRENT);
