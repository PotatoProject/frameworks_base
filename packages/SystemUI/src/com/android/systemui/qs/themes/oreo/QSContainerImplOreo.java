...
package com.android.systemui.qs.themes.oreo;
 ...
 */
public class QSContainerImplOreo extends FrameLayout implements QSContainer {
    ...
    public QSContainerImplOreo(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
