...
public class QSFooterImpl extends FrameLayout implements QSFooter,
    ...
    private void updateVisibilities() {
        ...
        mMobileGroup.setVisibility(mOreoQsPanel ? View.GONE : View.VISIBLE);
        mMobileSignal.setVisibility(mOreoQsPanel ? View.GONE : View.VISIBLE);
        mMobileRoaming.setVisibility(mOreoQsPanel ? View.GONE : View.VISIBLE);
        mCarrierText.setVisibility(mOreoQsPanel ? View.GONE : View.VISIBLE);
    }
