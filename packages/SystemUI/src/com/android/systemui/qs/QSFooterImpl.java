...
public class QSFooterImpl extends FrameLayout implements QSFooter ,NextAlarmChangeCallback,
    ...
    private void updateAnimator(int width) {
        ...
        mSettingsCogAnimator = new Builder()
                ...
                .addFloat(mSettingsContainer, "translationX",
                        mOreoQsPanel ? -(remaining - defSpace) : 0, 0)
    ...
    public void onNextAlarmChanged(AlarmManager.AlarmClockInfo nextAlarm) {
        ...
        if (nextAlarm != null) {
            String alarmString = QuickStatusBarHeader.formatNextAlarm(getContext(), nextAlarm);
