package com.android.systemui.blur.opengl.functor;
...
import com.android.systemui.blur.opengl.cache.FrameBufferCache;
import com.android.systemui.blur.opengl.cache.TextureCache;
import com.android.systemui.blur.opengl.program.ProgramFactory;
import com.android.systemui.blur.util.ColorUtil;
...
import static com.android.systemui.blur.util.ShaderUtil.checkGLError;
import static com.android.systemui.blur.util.ShaderUtil.getCopyFragmentCode;
import static com.android.systemui.blur.util.ShaderUtil.getFragmentShaderCode;
import static com.android.systemui.blur.util.ShaderUtil.getVertexCode;
...
public class ScreenBlurRenderer implements IRenderer<DrawFunctor.GLInfo> {
    ...
    private Buffer mDrawListBuffer;
