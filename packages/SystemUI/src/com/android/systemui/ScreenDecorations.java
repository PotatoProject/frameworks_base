    ...
    public void onTuningChanged(String key, String newValue) {
        mHandler.post(() -> {
            ...
            if (SIZE.equals(key) || SIZE_TOP.equals(key) || SIZE_BOTTOM.equals(key)) {
                ...
                int size = Secure.getInt(resolver, SIZE, mRoundedDefault / mDensity) * mDensity;
                int sizeTop = Secure.getInt(resolver, SIZE_TOP, mRoundedDefault / mDensity) * mDensity;
                int sizeBottom = Secure.getInt(resolver, SIZE_BOTTOM, mRoundedDefault / mDensity) * mDensity;
                if (newValue != null) {
                    try {
                        switch (key) {
                            case SIZE:
