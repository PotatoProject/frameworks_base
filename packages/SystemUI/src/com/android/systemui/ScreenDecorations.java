    ...
    public void onTuningChanged(String key, String newValue) {
        mHandler.post(() -> {
            ...
            if (SIZE.equals(key) || SIZE_TOP.equals(key) || SIZE_BOTTOM.equals(key)) {
                ...
                int sizeTop = (int) (Secure.getInt(resolver, SIZE_TOP, (int) (mRoundedDefault / mDensity)) * mDensity);
                int sizeBottom = (int) (Secure.getInt(resolver, SIZE_BOTTOM, (int) (mRoundedDefault / mDensity)) * mDensity);
                if (newValue != null) {
                    try {
                        switch (key) {
                            case SIZE:
