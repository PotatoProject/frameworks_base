...
public class SignalDrawable extends Drawable {
    ...
    public SignalDrawable(Context context) {
        mDarkModeBackgroundColor =
                Utils.getColorStateListDefaultColor(context, R.color.dark_mode_icon_color_dual_tone_background);
        mDarkModeFillColor =
                Utils.getColorStateListDefaultColor(context, R.color.dark_mode_icon_color_dual_tone_fill);
        mLightModeBackgroundColor =
                Utils.getColorStateListDefaultColor(context, R.color.light_mode_icon_color_dual_tone_background);
        mLightModeFillColor =
