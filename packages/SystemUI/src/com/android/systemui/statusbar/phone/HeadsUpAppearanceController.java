...
public class HeadsUpAppearanceController implements OnHeadsUpChangedListener,
    ...
    private final View mPotatoLogoView;
    ...
    public HeadsUpAppearanceController(
        ...
        mPotatoLogoView = PotatoLogoView;
    ...
    private void setShown(boolean isShown) {
        if (mShown != isShown) {
            ...
            if (isShown) {
               ...
               if (mPotatoLogoView.getVisibility() != View.GONE) {
                    hide(mPotatoLogoView, View.INVISIBLE);
                }
            } else {
                if (((Clock)mClockView).shouldBeVisible()) {
                    show(mClockView);
