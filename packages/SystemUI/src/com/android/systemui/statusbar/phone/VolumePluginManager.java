...
public class VolumePluginManager extends BroadcastReceiver {
    ...
    private boolean setPlugin(String packageName) {
        final String currentPackageName = getEnabledPlugin();

        if(mCurrentPlugin != currentPackageName) {
        ...
        if (mCurrentPlugin.equals(packageName) &&
                mCurrentPlugin.equals(currentPackageName)) {
            // Already set.
            return true;
        }
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            String value = Settings.System.getString(resolver, "systemui_plugin_volume");
            if (value != mCurrentPlugin) {
                if(value == null || value == DEFAULT_VOLUME_PLUGIN) {
