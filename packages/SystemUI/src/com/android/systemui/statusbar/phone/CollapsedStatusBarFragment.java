...
public class CollapsedStatusBarFragment extends Fragment implements CommandQueue.Callbacks,
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mPotatoLogo = (ImageView)mStatusBar.findViewById(R.id.status_bar_logo);
        Dependency.get(DarkIconDispatcher.class).addDarkReceiver(mPotatoLogo);
    ...
    public void onDestroyView() {
        ...
        Dependency.get(DarkIconDispatcher.class).removeDarkReceiver(mPotatoLogo);
    }
    ...
    public void hideNotificationIconArea(boolean animate) {
        ...
        if (mShowLogo) {
            animateHide(mPotatoLogo, animate);
        }
    }
    ...
    public void showNotificationIconArea(boolean animate) {
        ...
        if (mShowLogo) {
            animateShow(mPotatoLogo, animate);
        }
    }
    ...
    public void updateSettings(boolean animate) {
        ...
        if (mNotificationIconAreaInner != null) {
            if (mShowLogo) {
                ...
                animateHiddenState(mPotatoLogo, View.GONE, animate);
            }
        }
    }
}
