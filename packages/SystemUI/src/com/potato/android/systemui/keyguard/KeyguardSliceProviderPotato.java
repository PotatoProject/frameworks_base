package com.potato.android.systemui.keyguard;
...
public class KeyguardSliceProviderPotato extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderPotato> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderPotato keyguardSliceProviderPotato, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderPotato);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderPotato.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderPotato keyguardSliceProviderPotato;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderPotato = (KeyguardSliceProviderPotato) mProviderReference.get();
            }
            if (keyguardSliceProviderPotato != null) {
                keyguardSliceProviderPotato.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderPotato#onBindSlice");
        Slice slice;
