...
package com.potato.android.systemui.theme
...
@SysUISingleton
class ThemeOverlayControllerPotato @Inject constructor(
    ...
    private var colorOverride: Int = Settings.Secure.getInt(mContext.contentResolver, PREF_COLOR_OVERRIDE, -1)
    ...
    private var whiteLuminance: Double = parseWhiteLuminanceUser(
    ...
    override fun onTuningChanged(key: String?, newValue: String?) {
        key?.let {
            if (it.contains(PREF_PREFIX)) {
                ...
                chromaFactor = Settings.Secure.getFloat(mContext.contentResolver, PREF_CHROMA_FACTOR, 1.0f).toDouble()
    ...
    companion object {
        private const val TAG = "ThemeOverlayControllerPotato"
