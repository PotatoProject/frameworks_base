package com.potato.android.systemui.smartspace
...
class KeyguardSmartspaceController @Inject constructor(
    ...
    init {
        if (!featureFlags.isSmartspaceEnabled()) {
            context.packageManager.setComponentEnabledSetting(ComponentName("com.android.systemui", "com.potato.android.systemui.keyguard.KeyguardSliceProviderPotato"), 1, 1)
        } else {
