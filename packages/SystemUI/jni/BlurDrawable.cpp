...
Java_com_android_systemui_blur_opengl_functor_DrawFunctor_createNativeFunctor(JNIEnv *env, jobject clazz,
...
Java_com_android_systemui_blur_opengl_functor_DrawFunctor_releaseFunctor(JNIEnv *env, jobject clazz,
                                                             jlong j_functor_ptr) {
...
void postEventFromNativeC(int mode, void *info, jobject functor) {
    ...
    jmethodID mPostMethodID = env->GetStaticMethodID((jclass) mFunctorClazz, "postEventFromNative",
                                                     "(Ljava/lang/ref/WeakReference;Lcom/android/systemui/blur/opengl/functor/DrawFunctor$GLInfo;I)V");
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    // find functor class
    functorCls = env->FindClass("com/android/systemui/blur/opengl/functor/DrawFunctor");
    glInfoCls = env->FindClass("com/android/systemui/blur/opengl/functor/DrawFunctor$GLInfo");
